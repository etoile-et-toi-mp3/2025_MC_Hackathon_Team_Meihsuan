namespace Loupedeck.MeihsuanPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MeihsuanPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MeihsuanPlugin.Resources.Resource.txt`.
