...
{     
    ...
    {            
        ...
        {             
            ...
            {
                // 修改這些路徑為你的實際路徑
                string pythonPath = @"C:\Users\USER\ExamplePlugin\src\Actions\.venv39\Scripts\python.exe";  // 你的虛擬環境 Python 路徑
                string scriptPath = @"C:\Users\USER\ExamplePlugin\src\Actions\fixed_meeting.py";  // 你的 Python 腳本路徑
