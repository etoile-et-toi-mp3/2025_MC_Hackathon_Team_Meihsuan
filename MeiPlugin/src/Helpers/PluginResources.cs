namespace Loupedeck.MeiPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MeiPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MeiPlugin.Resources.Resource.txt`.
