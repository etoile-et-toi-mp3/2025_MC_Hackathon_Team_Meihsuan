namespace Loupedeck.FloWorkPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.FloWorkPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.FloWorkPlugin.Resources.Resource.txt`.
